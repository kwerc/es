...
CFLAGS	= $(ADDCFLAGS) -I. -I$(srcdir) -W -Wall -Wno-missing-field-initializers -Wno-unused-parameter -Wno-clobbered -g -O2
LDFLAGS	= $(ADDLDFLAGS) 
...
SIGFILES = /usr/include/machine/_limits.h /usr/include/machine/_types.h /usr/include/machine/signal.h /usr/include/machine/trap.h /usr/include/signal.h /usr/include/sys/_sigset.h /usr/include/sys/_types.h /usr/include/sys/cdefs.h /usr/include/sys/signal.h /usr/include/x86/_limits.h /usr/include/x86/_types.h /usr/include/x86/signal.h /usr/include/x86/trap.h 
